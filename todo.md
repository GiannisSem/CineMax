...
FUNZIONALITA':
- registraCliente() -> inserisci i dati (fatto)
- visualizzaPrenotazione() -> dopo la ricerca (fatto)
...
- in cinemaxmanager aggiungere i metodi per cercare le prenotazioni
    ...
    - uno che return una lista e cerca per nome, cognome (fatto)
    - uno da titolo del film (fatto)
    - una tra un intervallo di date (fatto)
    - fare file prenotazioni (fatto)

SCOMMENTA TUTTI I SCRITTORI DEI FILE!!